 ...
 */
@WebServlet("/manager/updateProfession.do")
public class ProfessionUpdateController extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        professionalTitlesService.updateProfession(professionalTitles);
